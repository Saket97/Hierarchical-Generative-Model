...
def load_dataset():
    ...
    return raw_data[0:ntrain],cov[0:ntrain],labels_tb[0:ntrain],raw_data[ntrain:],cov[ntrain:],labels_tb[ntrain:]

X_train, C_train, Ltb_train, X_test, C_test, Ltb_test1 = load_dataset()
print("inp_data_dim:",inp_data_dim)
print("inp_cov_dim:",inp_cov_dim)
X_test = X_test.astype(np.float32)
C_test = C_test.astype(np.float32)
n1 = (Ltb_train==1).nonzero()[0].shape[0]
n0 = (Ltb_train==0).nonzero()[0].shape[0]
n2 = (Ltb_train==2).nonzero()[0].shape[0]
print("Input Train: For ","Tb"," #1:",n1," #0:",n0, " #2:",n2)
...
if __name__ == "__main__":
    ...
    closs = tb_coeff*(closs2+closs3+closs4)
